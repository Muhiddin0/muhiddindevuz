          ...
          <AnimatePresence>
            ...
            <FadeUp key="description" duration={0.6} delay={0.2}>
              <div className="mt-8 max-w-3xl text-base font-semibold text-zinc-900 dark:text-zinc-200 sm:text-base md:text-2xl">
                <span className="text-xl text-accent sm:text-3xl">Salom.</span>{" "}
                Mening ismim
                <span className="text-accent"> Muhiddin.</span> men kod va
                dizayn yordamida ko&apos;rishni haqiqatga aylantiraman.
              </div>
            </FadeUp>
          </AnimatePresence>
        </div>
